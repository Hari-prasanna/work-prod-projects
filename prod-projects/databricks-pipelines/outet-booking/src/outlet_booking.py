...
PROJECT_DIR = "/Workspace/Users/hari.prasanna.ravichandran@zalando.de/team-repo/databricks/outet-booking/src"
UTILS_DIR = "/Workspace/Users/hari.prasanna.ravichandran@zalando.de/team-repo/databricks/dbricks-utils"

JOB_NAME = "Outlet Booking"

# Set to a test webhook URL while testing; remove before deploying to prod
TEST_WEBHOOK_URL = ""
...
def setup_connections(config: dict, dbx_utils):
    """Sets up Google Sheets, Oracle, and webhook connections."""
...
def fetch_data(engine, config: dict, start_dt: str, end_dt: str):
    """Runs the SQL query against Oracle and returns the result as a DataFrame."""
...
def update_sheet(sheet, df, target_date: str):
    """Replaces existing rows for the target date and appends fresh data."""
...
def main():
    logger.info("Starting Daily Outlet Booking Job")
